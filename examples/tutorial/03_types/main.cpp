...
int main() {
    ...
    std::cout << std::boolalpha << (couscous::result_type<SomeStruct<int>,couscous::ObjVars>(hana::size_c<0>).value() == hana::type_c<int&&>) << std::endl;
    std::cout << (couscous::result_type<SomeStruct<int>,couscous::ObjMethods>(hana::size_c<0>).value() == hana::type_c<char*>) << std::endl;
    std::cout << (couscous::result_type<OtherStruct<>,couscous::ObjMethods>(hana::size_c<0>).value() == hana::type_c<int>) << std::endl;
    std::cout << (couscous::result_type<OtherStruct<>,couscous::ObjMethods>(hana::size_c<1>).value() == hana::type_c<const char*>) << std::endl;
    //Also we can use MethodInfo which will return types
    std::cout << (hana::type_c<couscous::MethodInfo<SomeStruct<int>,0,couscous::ObjMethods>::result_type> == hana::type_c<char*>) << std::endl;
    ...
    std::cout << (couscous::methods_args_count<OtherStruct<int,std::string,double,double>,couscous::ObjMethods>(hana::size_c<0>).value() == hana::size_c<5>)
              << std::endl;
    std::cout << (couscous::MethodInfo<SomeStruct<float>,0,couscous::StaticMethods>::args_count == hana::size_c<0>) << std::endl;
