...
public:
    ...
    using result_type = metautils::optional_type_helper_t<std::decay_t<decltype(metautils::get_opt_val(utils::method_result_type<T,Generator>(::boost::hana::size_c<I>)))>>; /**< result type of method */
