 ...
 * @param args - Arguments of invocation
 * @return boost::hana::optional<...> of boost::hana::tuple<...> or
 * boost::hana::nothing
 */
...
constexpr decltype(auto) gets_impl(IndexTuple &&inds_tup,
                                   ...
                                   Args &&... args) {
  if
    constexpr(decltype(::boost::hana::greater_equal(
        ...
        ::boost::hana::size(inds_tup)))::value) return ::boost::hana::
        just(metautils::multiple_concat(
            ::boost::hana::make_tuple(metautils::get_opt_val(
...
constexpr decltype(auto) sets_impl(IndexTuple &&inds_tup, SetArg &&s_arg,
  ...
  if
    constexpr(decltype(::boost::hana::greater_equal(
      ...
      return ::boost::hana::just(metautils::multiple_concat(
          ::boost::hana::make_tuple(metautils::get_opt_val(
              set<T, Generator>(::boost::hana::at_c<Indices>(inds_tup),
                                ::std::forward<SetArg>(s_arg),
                                ::std::forward<Args>(args)...)))...));
    }
  else
    return ::boost::hana::nothing;
...
gets_unpack_tuple_element_impl(I &&index, Tuple &&tup,
                               ::std::index_sequence<Indices...> &&) {
  return ::boost::hana::make_tuple(metautils::get_opt_val(get<T, Generator>(
...
constexpr decltype(auto) gets_tuple_element_impl(I &&index, Tuple &&tup) {
  if
    constexpr(
        ::std::is_same<::boost::hana::tuple_tag,
                       ::boost::hana::tag_of_t<::std::decay_t<Tuple>>>::value) {
      return gets_unpack_tuple_element_impl<T, Generator>(
          ...
          ::std::make_index_sequence<decltype(
              ::boost::hana::size(tup))::value>());
    }
  else
    return ::boost::hana::make_tuple(::boost::hana::nothing);
}
...
gets_tuple_args_impl(IndexTuple &&inds_tup, ArgsTuple &&args_tup,
  ...
  return ::boost::hana::just(
      metautils::multiple_concat(gets_tuple_element_impl<T, Generator>(
...
sets_unpack_tuple_element_impl(I &&index, SetArg &&s_arg, Tuple &&tup,
                               ::std::index_sequence<Indices...> &&) {
  return ::boost::hana::make_tuple(metautils::get_opt_val(
  ...
  if
    constexpr(
      ...
      return sets_unpack_tuple_element_impl<T, Generator>(
          ...
          ::std::forward<Tuple>(tup), ::std::make_index_sequence<decltype(
                                          ::boost::hana::size(tup))::value>());
    }
  else
    return ::boost::hana::make_tuple(::boost::hana::nothing);
...
sets_tuple_args_impl(IndexTuple &&inds_tup, SetArgTuple &&s_args_tup,
                     ...
                     ::std::index_sequence<Indices...> &&) {
  return ::boost::hana::just(
      metautils::multiple_concat(sets_tuple_element_impl<T, Generator>(
          ::boost::hana::at_c<Indices>(inds_tup),
 ...
 * @return boost::hana::optional<...> of object which type is type of variable
 * or result type of method(bost::hana::type_c<void> if result type is void) or
        ...
        constexpr(decltype(::boost::hana::equal(
          ...
          if
            constexpr(
              ...
              return ::boost::hana::just(detail::get_impl(
                  ::boost::hana::at(metautils::copy_tuple_sequence(
                                        MetaClass<T>::metadata,
                                        Generator::template generate<decltype(
                                            MetaClass<T>::metadata)>()),
 ...
 * @param s_arg - rvalue argument
 * @param args - Invocation arguments
 * @return boost::hana::optional<boost::hana::bool_c<true>> or
 * boost::hana::nothing
 */
template <class T, class Generator = info::DefaultIndexGenerator, class I,
    ...
    constexpr(
        ...
        (info::is_generator_v<::std::decay_t<Generator>>)&&(
            ::std::is_same<
                ...
                ::boost::hana::tag_of_t<::std::decay_t<IndexTuple>>>::value)) {
...
constexpr decltype(auto) gets_tuple_args(IndexTuple &&inds_tup,
  ...
  if
    constexpr(
        ...
        (::std::is_same<
            ::boost::hana::tuple_tag,
            ::boost::hana::tag_of_t<::std::decay_t<ArgsTuple>>>::value)) {
      if
        constexpr(decltype(
            ::boost::hana::equal(::boost::hana::size(inds_tup),
...
constexpr decltype(auto) sets_tuple_args(IndexTuple &&inds_tup,
  ...
  if
    constexpr(
        ...
        (::std::is_same<
            ::boost::hana::tuple_tag,
            ::boost::hana::tag_of_t<::std::decay_t<SetArgTuple>>>::value)) {
      if
        constexpr((decltype(::boost::hana::equal(
                      ::boost::hana::size(inds_tup),
                      ::boost::hana::size(args_tup)))::value) &&
                  (decltype(::boost::hana::equal(
                      ::boost::hana::size(inds_tup),
