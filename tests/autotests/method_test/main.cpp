...
void MethodTest::sets_tuple_args_method() {
    value = true;
    value2 = false;
    constexpr auto indices = boost::hana::concat(reflect::utils::find_name<Type,reflect::AllMethods>(HANA_STR("bool_method2")).value(),
                                                 reflect::utils::find_name<Type,reflect::AllMethods>(HANA_STR("bool_method3")).value());
